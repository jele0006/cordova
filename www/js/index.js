const app = {
    ...
    showThings: function(){
        ...
        list.innerHTML = '';
        list.appendChild(app.buildCard(app.DATA.roles));
    ...
    buildCard: function(arr){
        ...
        arr.forEach((spec) => {
            ...
            title.setAttribute("data-key", spec.id);
    ...
    getItem: function(id){
        ...
        return app.DATA.roles[parseInt(id)-1];
    },
    ...
    showDetails: function(obj){
        ...
        obj.characters.forEach((char)=>{
            ...
            let title = document.createElement('h2');
            title.className = 'item-title';
            title.setAttribute("data-key", char.id);
            title.innerHTML = char.name;
            
            let desc = document.createElement('p');
            desc.className = 'item-desc';
            desc.innerHTML = '';   /*********************IMPORTANT****************/
            card.appendChild(img);
            card.appendChild(title);
            card.appendChild(desc);
            df.appendChild(card);
